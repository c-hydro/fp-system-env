...
fp_folder_root_default=$HOME/fp_virtualenv_python3_hat
fileref_env_default='fp_virtualenv_python3_hat_settings'
fp_env_libs_default='fp_virtualenv_python3_hat_libraries'
#-----------------------------------------------------------------------------------------
