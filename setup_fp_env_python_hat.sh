...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP ENVIRONMENT - PYTHON3 LIBRARIES FOR HAT PACKAGE'
...
fp_env_file_reference_default='fp_virtualenv_python3_hat_settings'
fp_env_folder_libraries_default='fp_virtualenv_python3_hat_libraries'

fp_env_file_requirements_default='requirements_fp_env_python_hat.yaml'
